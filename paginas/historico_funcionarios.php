...
<head>
    ...
    <title>Histórico de administrações com funcionários - Sailus</title>
</head>
<body>
    <?php
    ...
    <div class="titleList">
        <h1>Histórico de ações de administradores com funcionários</h1>
    </div>
        ...
        <div class="list-container">
            <div class="buscar-e-adicionar-container">
                ...
                <div class="btn-adicionar-container">
                    <a href="inicio_funcionarios.php">Voltar</a>
                </div>
            </div>
                        ...
                        <?php if(!empty($historicos)): ?>
                            <?php foreach($historicos as $historico): ?>
                                <?php
                                    ...
                                    $funcionario = buscar('Usuario', ['nome', 'tipoUsuario'], $criterio_buscar_funcionario);

                                    if($funcionario[0]['tipoUsuario'] == 'Funcionario')
                                    {
                                    ...
                                    {
                                        $tipo_funcionario = false;
                                    }
                                ?>

                                <?php if($tipo_funcionario == true): ?>
                                    <tr>
